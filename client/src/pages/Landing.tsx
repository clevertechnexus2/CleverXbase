    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative z-10 pt-28 pb-20 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-display font-black tracking-tight mb-4" style={{ fontSize: 'clamp(3rem, 10vw, 7rem)', lineHeight: 1 }}>
            <span className="text-primary" style={{ filter: 'drop-shadow(0 0 10px hsl(120 100% 50% / 0.2))' }}>Clever</span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="https://github.com/clevertechnexus2/CleverXbase"
              target="_blank"
      ...
      <section className="relative z-10 px-6 pb-20">
        <div className="max-w-3xl mx-auto card p-5 neon-border">
          ...
          <div className="rounded-lg px-4 py-3 font-mono text-sm overflow-x-auto" style={{ background: '#050505', border: '1px solid hsl(120 100% 50% / 0.12)' }}>
            ...
            <span style={{ color: '#4488ff' }}>database.clevertechnexus.qzz.io</span>
      ...
      <section className="relative z-10 px-6 pb-28">
        <div className="max-w-2xl mx-auto text-center card p-10 neon-border">
          ...
          <p className="text-gray-600 font-mono text-sm mb-7">Sign in to your CleverXbase dashboard and take control of your MongoDB databases.</p>
          <Link
            to="/login"
        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display font-bold text-sm tracking-widest">
              <span className="text-primary">Clever</span><span className="text-gray-500">Xbase</span>
            </span>
          </div>
          ...
          <p className="text-gray-800 text-xs font-mono">© {new Date().getFullYear()} Clever Tech Nexus ~ CleverXbase. All systems operational.</p>
        </div>
      </footer>
    </div>
  );
