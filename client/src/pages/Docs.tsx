...
╚══════════════════════════════════════╝`} />
          ...
          <Section id="deployment" title="VPS Deployment" icon={Rocket}>
            <p className="text-slate-400 text-sm leading-relaxed">
              CleverXbase runs as a single Node.js process — it starts MongoDB, builds the frontend,
              and serves the API. Everything is self-contained.
            </p>

            <div className="space-y-0">
              <Step n={1} title="Clone and install">
                <CodeBlock code={`git clone https://github.com/clevertechnexus2/CleverXbase.git
cd CleverXbase
npm install
...
pm2 start server.js --name CleverXbase
pm2 save
...
ufw allow 27018/tcp`} />
              ...
              <Step n={5} title="First login">
                ...
                <CodeBlock code={`pm2 logs CleverXbase --lines 50 | grep -A5 "CREDENTIALS"`} />
              </Step>
            </div>
