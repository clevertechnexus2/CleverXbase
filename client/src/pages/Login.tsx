      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mt-5 mb-6">
          ...
          <span className="text-gray-700 text-xs font-mono">
            Built by{' '}
            <span className="text-gray-500">Clever Tech Nexus ~ CleverXbase</span>
          </span>
        </div>
        ...
        <nav className="flex items-center justify-center flex-wrap gap-x-3 gap-y-1.5 text-xs font-mono">
          ...
          <span className="text-gray-800">·</span>
          <a href="mailto:support@clevertechnexus.qzz.io" className="text-gray-700 hover:text-primary transition-colors">Support</a>
        </nav>
      </div>
    </div>
  );
