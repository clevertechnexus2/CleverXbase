...
export default function Terms() {
  return (
    <LegalLayout
      ...
      subtitle="Please read these terms carefully before using CleverXbase."
      lastUpdated="January 2025"
    >
      <H2>1. Acceptance of Terms</H2>
      <P>
        By installing, accessing, or using CleverXbase ("the Software"), you agree to be bound by these Terms of Service.
        If you do not agree to these terms, do not install or use the Software.
      </P>
      <P>
        These terms apply to all users of CleverXbase, including the <Highlight>admin</Highlight> account and any
        additional accounts created within the dashboard.
      </P>

      <H2>2. Description of Service</H2>
      <P>
        CleverXbase is a <Highlight>self-hosted</Highlight> MongoDB management dashboard. It is provided as open-source
        software for installation and operation on your own server or VPS infrastructure. Clever Tech Nexus ~ CleverXbase does not host,
        operate, or manage any CleverXbase instance on your behalf.
      </P>

      <H2>3. Permitted Use</H2>
      <P>You may use CleverXbase to:</P>
      <Ul>
      ...
      <P>You must not use CleverXbase to:</P>
      <Ul>
      ...
      <P>
        Because CleverXbase is self-hosted, <Highlight>you are entirely responsible</Highlight> for the security of your
      ...
      <P>
        All data stored in your CleverXbase instance remains <Highlight>entirely yours</Highlight>. Clever Tech Nexus ~ CleverXbase has no
      ...
      <H2>7. No Warranty</H2>
      <P>
        CleverXbase is provided <Highlight>"as is"</Highlight> without warranty of any kind, express or implied,
      ...
      <P>
        To the fullest extent permitted by law, Clever Tech Nexus ~ CleverXbase and Silent Wolf shall not be liable for any direct, indirect,
        incidental, special, consequential, or exemplary damages arising from your use of, or inability to use,
        CleverXbase — including but not limited to data loss, data breach, service interruption, or loss of revenue.
      </P>

      <H2>9. Third-Party Software</H2>
      <P>
        CleverXbase bundles and depends on third-party open-source packages, including MongoDB Community Server (licensed
      ...
      <P>
        ...
        <a href="mailto:support@clevertechnexus.qzz.io" className="text-primary hover:underline">support@clevertechnexus.qzz.io</a>
      </P>
    </LegalLayout>
  );
}
