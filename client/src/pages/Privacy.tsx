...
export default function Privacy() {
  return (
    <LegalLayout
      ...
      subtitle="How CleverXbase handles data — yours, your users', and ours."
      lastUpdated="January 2025"
    >
      <InfoBox title="The short version">
        CleverXbase is fully self-hosted. We (Clever Tech Nexus ~ CleverXbase) have{' '}
      ...
      <H2>1. Who We Are</H2>
      <P>
        CleverXbase is developed and maintained by <Highlight>Clever Tech Nexus ~ CleverXbase</Highlight>.
      ...
      <P>Because CleverXbase is self-hosted software, we do <Highlight>not</Highlight> collect:</P>
      <Ul>
      ...
      <P>
        Your CleverXbase instance runs entirely on your own infrastructure. All data flows between your browser and your
        server — never through our systems.
      </P>

      <H2>3. Data Stored Locally on Your Server</H2>
      <P>CleverXbase stores the following data on your server only:</P>
      <Ul>
      ...
      <P>CleverXbase sets one session cookie when you log in. This cookie:</P>
      <Ul>
      ...
      <P>
        If you use CleverXbase to store data about your own users or customers, you are the <Highlight>data controller</Highlight>
      ...
      <P>
        CleverXbase does not integrate with any third-party analytics, advertising, or tracking services. The software
        makes no outbound network requests except to MongoDB (running on your own server).
      </P>

      <H2>7. Open Source Repository</H2>
      <P>
        The CleverXbase source code is publicly available. If you contribute code, issues, or comments to the repository,
      ...
      <P>
        CleverXbase is intended for use by adults operating server infrastructure. It is not designed for, or directed at,
